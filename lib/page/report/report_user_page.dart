...
class _ReportUserPageState extends State<ReportUserPage> {
  ...
  int _taskType = ReportUserType.fanzui.index;
  ...
  void submitReport() async {
    ...
    final res = await apiReportUser(updata);
                  ...
                  Row(
                    children: [
                      ...
                      CupertinoButton(
                        ...
                        child:Row(
                          children: [
                            Text(ReportName.nameUser[_taskType],style:const TextStyle(fontSize: 16),),
                            const Icon(Icons.keyboard_arrow_right_rounded)
                          ],
                        ),
                        onPressed: () {
                          Get.to(()=> const SingleSelectPage(),arguments: {"values":ReportName.nameUser,"select":_taskType})?.then((value) {
                            if (value != null) {
                              _taskType = value;
                              setState(() {
                              });
